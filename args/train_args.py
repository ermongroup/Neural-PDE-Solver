...
class TrainArgs(BaseArgs):
  def __init__(self):
    ...
    self.parser.add_argument('--lr_decay_start', type=int, default=100,
                             help='epoch at which lr decay starts')
    self.parser.add_argument('--load_ckpt_dir', type=str, default='',
